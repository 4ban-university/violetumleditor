...
public class SCMProjectMenu extends JMenu {
    ...
    public static String composeMap(IGraph iGraph) {
        Collection<INode> objects = iGraph.getAllNodes();
        Collection<IEdge> links = iGraph.getAllEdges();
    ...
    private void createMenu() {
        ...
        Feature3Item.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                JOptionPane.showMessageDialog(null, composeMap(mainFrame.getActiveWorkspace().getGraphFile().getGraph()));
            }
