...
public class SCMPFeature1Test {
	...
	@Test
	public void TestSelfDirectionAggregation() {
		        ...
		        editorPart.setFeature1(true);// enabled the feature 1
		        	
		        assertFalse(addEdge.addEdgeAtPoints(connection1, startLocation1, endLocation1));//trying to create second edge on same class
		  assertTrue(addEdge.addEdgeAtPoints(connection2, startLocation2, endLocation2));//trying to create edge on other class
		
	}
	
	@Test
	public void TestSelfDirectionComposition() {
		        ...
		        AddEdgeBehavior addEdge=new AddEdgeBehavior(editorPart, graphsToolBar);
		        CompositionEdge connection0=new CompositionEdge();
		        CompositionEdge connection1=new CompositionEdge();
		        CompositionEdge connection2=new CompositionEdge();
		        ...
		        addEdge.addEdgeAtPoints(connection0, startLocation0, endLocation0);
		        editorPart.setFeature1(true);  //enabled feature 1
